...
const defaultProducts: Product[] = [
  ...
  {
    id: "tottenham-pro-third-2024",
    name: "Tottenham Pro Third Shirt 2023/24",
    description: "Official Tottenham Hotspur professional third shirt for the 2023/24 season. Premium player issue quality with unique alternative design.",
    price: 119.99,
    images: ["/products/shirts/tottenham-pro-third-2024.jpg"],
    category: "premier-league",
    team: "Tottenham",
    size: ["S", "M", "L", "XL", "XXL"],
    season: "2023/24",
