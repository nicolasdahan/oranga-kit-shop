...
const translations = {
  en: {
    ...
    'auth.registerDescription': 'Créez votre compte',
    'auth.email': 'Email',
    ...
    'auth.acceptTermsRequired': 'Veuillez accepter les conditions d\'utilisation',
    ...
    'auth.facebookError': 'Connexion Facebook échouée. Veuillez réessayer.',
